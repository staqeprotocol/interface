...
const AddFirstStake = () => (
  <div className="timeline-start md:text-end mb-10 w-full">
    ...
    >
      <div className="rounded-2xl bg-neutral-800 mx-auto py-20 text-center w-full hover:bg-neutral-900">
        Add First Stake
      </div>
    </a>
  </div>
      ...
      <div className="grid grid-cols-2 grid-rows-1 grid-flow-row gap-2 mt-2">
        <div>
          <div className="grid grid-cols-2 grid-rows-1 grid-flow-row gap-2">
            <div className="p-1 pb-2 bg-stone-900 rounded-xl text-center">
              <div className="w-full">
              ...
              <div>
                {accountStakes?.length ? (
                  ...
                  <div className="w-full text-gray-700 h-10">NONE</div>
                )}
              </div>
            </div>
            <div className="p-1 pb-2 bg-stone-900 rounded-xl text-center">
            ...
            return (
              <li key={data.type + "-" + data.pool.id + "-" + i}>
                ...
                {(data.type === "stake" ||
                  ...
                  <>
                    <div className="timeline-start md:text-end mb-10 w-full">
                      <div className="rounded-2xl bg-neutral-800 mx-auto py-10 text-center w-full">
                        {data.type === "reward" && (
                          <>
                            Your Reward:{" "}
                            <Link
                ...
                {(data.type === "launchPool" || data.type === "addReward") && (
                  <>
